...
const SeatLayout = () => {
  ...
  const timings = show.dateTime[date] || null
  ...
  return (
    <div className='flex flex-col md:flex-row px-6 md:px-16 lg:px-40 py-30 md:pt-50'>
        ...
        <div className='mt-5 space-y-1'>
          {!timings && (
            <p className='text-sm px-6 text-red-500'>
              No timings found for this date: {date}
            </p>
          )}
      ...
      <div className='relative flex-1 flex flex-col items-center max-md:mt-16'>
        ...
        <button onClick={()=> navigate("/mybookings")} className='flex items-center gap-1 mt-20 px-10 py-3 text-sm
