...
//         <h1 className='text-5xl md:text-[70px] md:leading-18 font-semibold max-w-110'>Gurdians <br/>of the Galaxy</h1>
...
const navigate = useNavigate()
  ...
  return (
    <div
      ...
      <h1 className='text-5xl md:text-[70px] font-semibold leading-[70px]'>
      ...
      <p className='max-w-md text-gray-300'>In a post-apocalyoptic world where cities rise on wheels and 
        consume each other to survive, two people meet in London and try to stop a conspiracy.
      </p>
